...
class DatasetAttr:
    ...
    detection_images: Optional[str] = None
    clip_images: Optional[str] = None
    seg_images: Optional[str] = None
    ...
    for name in dataset_names:
        ...
        if "columns" in dataset_info[name]:
            ...
            if dataset_attr.formatting == "alpaca":
                ...
                column_names.extend(["messages", "detection_images", "clip_images", "seg_images"]) # , 'annotations'
