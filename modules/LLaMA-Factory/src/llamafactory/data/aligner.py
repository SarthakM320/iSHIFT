...
def convert_sharegpt(
    ...
    output = {
        ...
        "_images": convert_images(example[dataset_attr.images]) if dataset_attr.images else None,
        "_videos": convert_videos(example[dataset_attr.videos]) if dataset_attr.videos else None,
        "_detection_images": convert_images(example[dataset_attr.detection_images]) if dataset_attr.detection_images else None,
        "_clip_images": convert_images(example[dataset_attr.clip_images]) if dataset_attr.clip_images else None,
        "_seg_images": convert_images(example[dataset_attr.seg_images]) if dataset_attr.seg_images else None,
        # "_annotations": example[dataset_attr.annotations] if dataset_attr.annotations else None,

        # "_episode_id": int(example[dataset_attr.episode_id]) if dataset_attr.episode_id else None,
        # "_step_id": example[dataset_attr.step_id] if dataset_attr.step_id else None
    }
