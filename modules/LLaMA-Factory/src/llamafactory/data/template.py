...
def get_template_and_fix_tokenizer(tokenizer: "PreTrainedTokenizer", data_args: "DataArguments") -> "Template":
    ...
    """
    if data_args.template in ["llava", "paligemma", "qwen2_vl", "ishift_qwen2_vl"]:
...
_register_template(
    ...
    mm_plugin=get_mm_plugin(
        ...
        detection_image_token="<|detection_image_pad|>",
        detection_image_seqlen=256,
        clip_image_token="<|clip_image_pad|>",
        seg_image_token="<|seg_image_pad|>",
        seg_image_seqlen=256,
        ),
)
